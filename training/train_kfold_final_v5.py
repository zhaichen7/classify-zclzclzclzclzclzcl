"""
train_kfold_final_v5.py
K折交叉验证 + 三模态融合
RGB (3) + TIR (3) + VI (3: NDVI, GNDVI, SAVI from MS indices 5,6,7)
"""
import os
import sys
import torch
...
# ============================================================================
# 数据包装 - 提取植被指数 (NDVI, GNDVI, SAVI)
# ============================================================================

class VegetationIndexExtractor(Dataset):
    """从 MS 中提取植被指数 (indices 5, 6, 7)"""
    ...
    def __getitem__(self, idx):
        ...
        # MS 结构: [nir, red, blue, green, rededge, ndvi, gndvi, savi]
        # 提取植被指数: indices 5, 6, 7
        vi = ms[5:8, :, :]  # (3, 224, 224) - NDVI, GNDVI, SAVI
