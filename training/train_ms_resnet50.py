"""
train_ms_resnet50.py
使用 ResNet50 预训练模型训练 MS 单模态
预期: 55% → 65-75%
"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description="ResNet50 MS 单模态训练")
